...
!(function (t, n) {
    ...
    function u() {
        ...
        for (
            ...
            t.f && ((r = i = void 0), (u = (e = (n = t).d).o), (o = n.p), (l = n.u), (n.u = !1), o && ((i = []), (r = k(o, e, M({}, e), n.w, void 0 !== o.ownerSVGElement, null, i, l, null == u ? w(e) : u)), d(i, e), r != u && a(e)));
    }
    ...
    function R(t, n, i, r, e) {
        ...
        if ("key" === (n = e ? ("className" === n ? "class" : n) : "class" === n ? "className" : n) || "children" === n);
            ...
            "o" === n[0] && "n" === n[1]
                ? ((s = n !== (n = n.replace(/Capture$/, ""))), (n = ((c = n.toLowerCase()) in t ? c : n).slice(2)), i ? (r || t.addEventListener(n, v, s), ((t.t || (t.t = {}))[n] = i)) : t.removeEventListener(n, v, s))
                : "list" !== n && "tagName" !== n && "form" !== n && !e && n in t
                ? (t[n] = null == i ? "" : i)
                : "function" != typeof i && "dangerouslySetInnerHTML" !== n && (n !== (n = n.replace(/^xlink:?/, "")) ? (null == i || !1 === i ? t.removeAttributeNS("http://www.w3.org/1999/xlink", n.toLowerCase()) : t.setAttributeNS("http://www.w3.org/1999/xlink", n.toLowerCase(), i)) : null == i || !1 === i ? t.removeAttribute(n) : t.setAttribute(n, i));
    }
    function v(t) {
        ...
        try {
            t: if ("function" == typeof k) {
                if (
                    ...
                    i.c ? (b = (f = n.c = i.c).i = f.k) : ("prototype" in k && k.prototype.render ? (n.c = f = new k(p, w)) : ((n.c = f = new I(p, w)), (f.constructor = k), (f.render = z)), y && y.sub(f), (f.props = p), f.state || (f.state = {}), (f.context = w), (f.w = r), (h = f.f = !0), (f.m = [])),
                ...
                for (v = f.props, d = f.state, f.context = w, f.props = p, f.state = f.j, (a = m.M) && a(n), f.f = !1, f.d = n, f.p = t, a = f.render(f.props, f.state, f.context), n.n = A(null != a && a.type == O && null == a.key ? a.props.children : a), null != f.getChildContext && (r = M(M({}, r), f.getChildContext())), h || null == f.getSnapshotBeforeUpdate || (g = f.getSnapshotBeforeUpdate(v, d)), S(t, n, i, r, e, u, o, s, c), f.base = n.o; (a = f.m.pop()); )
                    ...
                    return (
                        null === n.type
                            ...
                            : n !== i &&
                              ...
                              l || ("value" in v && void 0 !== v.value && v.value !== t.value && (t.value = null == v.value ? "" : v.value), "checked" in v && void 0 !== v.checked && v.checked !== t.checked && (t.checked = v.checked))),
                        t
                    );
                })(i.o, n, i, r, e, u, o, c);
            (a = m.diffed) && a(n);
        ...
        return (
            ...
            (l.kelvinToRgb = function (t) {
                var n,
                    ...
                    r,
                    e = t / 100;
                return (r = e < 66 ? ((n = 255), (i = -155.25485562709179 - 0.44596950469579133 * (i = e - 2) + 104.49216199393888 * q(i)), e < 20 ? 0 : 0.8274096064007395 * (r = e - 10) - 254.76935184120902 + 115.67994401066147 * q(r)) : ((n = 351.97690566805693 + 0.114206453784165 * (n = e - 55) - 40.25366309332127 * q(n)), (i = 325.4494125711974 + 0.07943456536662342 * (i = e - 50) - 28.0852963507957 * q(i)), 255)), { r: J(Z(n), 0, 255), g: J(Z(i), 0, 255), b: J(Z(r), 0, 255) };
            }),
    ...
    function bt(t) {
        ...
        return h(
            "svg",
            { className: "IroHandle IroHandle--" + t.index + " " + (t.isActive ? "IroHandle--isActive" : ""), style: { "-webkit-tap-highlight-color": "rgba(0, 0, 0, 0);", transform: "translate(" + vt(t.x) + ", " + vt(t.y) + ")", willChange: "transform", top: vt(-n), left: vt(-n), width: vt(2 * n), height: vt(2 * n), position: "absolute", overflow: "visible" } },
            i &&
                h(
                    "use",
                    Object.assign(
    ...
    function pt(e) {
        ...
        return h(
            ...
            function (t, n, i) {
                return h(
                    "div",
                    Object.assign({}, n, { className: "IroSlider", style: Object.assign({}, { position: "relative", width: vt(r), height: vt(o), borderRadius: vt(l), background: "conic-gradient(#ccc 25%, #fff 0 50%, #ccc 0 75%, #fff 0)", backgroundSize: "8px 8px" }, i) }),
                    h("div", { className: "IroSliderGradient", style: Object.assign({}, { position: "absolute", top: 0, left: 0, width: "100%", height: "100%", borderRadius: vt(l), background: ht("linear", "horizontal" === e.layoutDirection ? "to top" : "to right", c) }, ft(e)) }),
        ...
        return h(
            ...
            function (t, n, i) {
                return h(
                    ...
                    h("div", { className: "IroBox", style: Object.assign({}, { width: "100%", height: "100%", borderRadius: vt(o) }, ft(e), { background: ht("linear", "to bottom", a[1]) + "," + ht("linear", "to right", a[0]) }) }),
                    l
                        .filter(function (t) {
                            return t !== c;
                        })
        ...
        return h(
            ...
            function (t, n, i) {
                return h(
                    ...
                    h("div", { className: "IroWheelHue", style: Object.assign({}, a, { transform: "rotateZ(" + (e.wheelAngle + 90) + "deg)", background: "clockwise" === e.wheelDirection ? "conic-gradient(red, yellow, lime, aqua, blue, magenta, red)" : "conic-gradient(red, magenta, blue, aqua, lime, yellow, red)" }) }),
